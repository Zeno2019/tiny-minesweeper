export default function BombIcon({ width, height, className }: IconProps) {
  return (
    <svg xmlns='http://www.w3.org/2000/svg' preserveAspectRatio='xMidYMid meet' viewBox='0 0 24 24' className={className} version='1.1' width={width} height={height}>
      <path
        fill='currentColor'
